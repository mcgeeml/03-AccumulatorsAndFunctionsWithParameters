...
#                   clone(), detach_from(window), attach_to(canvas)
#
#          -- Write the names of three INSTANCE VARIABLEs that Circle
#             objects have:
#                fill_color, default, center
#
...
#        necessary?  Why?
#            when constructing a window where graphic will be displayed, the method should be used. without the
#            call, the graphics would be drawn and disappear on their own.
#
